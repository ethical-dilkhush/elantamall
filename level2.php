    ...
    <div style="background-color: none;height:25px;width:100%">
      ...
      <center  id="lvl1" style="font-size: 20px;">Level 1</center>
        ...
        <div  style="background-color:none;height:25px;float:right;width:48%">
            <center id="lvl2" style="font-size: 20px;color:#0081FF;">Level 2</center>
          </div>
          
    </div>
    <hr id="hr1" style="border:1px solid #0081FF;width:48%;float:left;visibility:hidden">
    <hr id="hr2" style="border:1px solid #0081FF;width:48%;float:right;">
</center>
<br>
<div>
...
<div style="margin-left: 10px;">
    ...
    <br>
    <br>
    <span id="link" style="margin-top: 10px; color: grey;font-size: 15px;">https://elantamall.in/mall/pages/person/register?r_code=<?php echo $promotion_records['promotion_id']; ?></span>
    <hr style="margin-top: 10px;background-color: grey;">
