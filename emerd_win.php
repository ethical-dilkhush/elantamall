...
<!--parity sapre emered bcone and hr div -->
  ...
  <th><button onclick="location.href='emerd_win'"  style="color:#2196f3;height:40px;width:50%;float:right;background:none;border:0px;font-weight:bold;margin-right:12%">Emerd</button></th>
    ...
    <hr id="hr1" style="margin-top:0px;color:yellow;border: 1px solid #2196f3;width:20%;float:right;">
