...
<input id="pwd" name="passwd" onclick="pwd_color()" style="margin-top:30px;outline:none;text-indent:50px;" maxlength="20" autocomplete="off" type="password" placeholder="Password" required><br>
  ...
  if($total==1)
    {
      ...
      header('location:promotion_dept');
    }
