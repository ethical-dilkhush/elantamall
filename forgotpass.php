...
<body style="background-color: #f1f1f1; color: #333;">
    ...
    <center>
        ...
        <div>
            ...
            <input type="password" id="pwd" name="pass" maxlength="8" style="width:100%; height: 50px;font-size: medium; outline:none; border: 0px outset white; border-radius: 25px;text-indent:30px" placeholder="Enter New Password" required autocomplete="off"><br><br>
        </div>
        <div>
